    ...
    <section className="bg-gray-100 py-10 min-h-[200px] p-4">
      ...
      <form onSubmit={handleSubmit}>
        <div className='flex items-center justify-center gap-10'>
          <div className="max-w-5xl w-full mx-auto bg-white p-8 rounded-lg shadow-md border-2 border-dashed border-gray-400 text-center">
        ...
        <div className='flex items-center justify-end mt-6'>
          <button onClick={handleSubmit} type="submit" className="bg-blue-600 text-white px-6 py-2 rounded-full hover:bg-blue-700 transition">
            Submit
          </button>
        </div>
      </form>
...
export default BussinessVerification;
