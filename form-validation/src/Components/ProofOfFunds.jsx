...
// const ProofOfFunds = ({ goToNext, setStepComplete ,onVerified}) => {
...
//     // Notify Hero that this step is complete
//     setStepComplete(true);
    
//     goToNext(); // optional: only use this if you're not handling next from Hero
//   };
...
const ProofOfFunds = ({ goToNextStep, setStepComplete, onVerified }) => {
  const [selectedFile, setSelectedFile] = useState(null);
  const [proofName, setProofName] = useState('');
  const [savedData, setSavedData] = useState(null);
  ...
  const handleSubmit = (e) => {
    ...
    // Notify Hero (parent component) that this step is completed
    if (onVerified) onVerified(); // Optional: If you're using this for custom verification logic
